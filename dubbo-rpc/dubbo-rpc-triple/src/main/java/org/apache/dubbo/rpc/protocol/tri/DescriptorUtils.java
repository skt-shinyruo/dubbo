...
public final class DescriptorUtils {
    ...
    public static MethodDescriptor findTripleMethodDescriptor(
        ...
        if (request != null && CollectionUtils.isNotEmpty(request.getArgTypes())) {
            MethodDescriptor methodDescriptor = findMethodDescriptorByParamTypes(
                    methodDescriptors, request.getArgTypes().toArray(new String[0]));
